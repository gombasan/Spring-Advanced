...
public class ConcreteProxyConfig {
	...
	public OrderControllerV2 orderControllerV2Proxy(LogTrace logTrace) {
		OrderControllerV2 controllerImpl = new OrderControllerV2(orderServiceV2Proxy(logTrace));
		return new OrderControllerConcreteProxy(controllerImpl, logTrace);
	}
	@Bean
	public OrderServiceV2 orderServiceV2Proxy(LogTrace logTrace){
		OrderServiceV2 serviceImpl = new OrderServiceV2(orderRepositoryV2Proxy(logTrace));
